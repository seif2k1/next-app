...
export default function Home() {
  ...
  useEffect(() => {
    const projectId = "k9cx9iux";
    const dataset = "production";
    const apiVersion = "2023-05-26";
    const token =
      "skIYoMj5V7AJa5whi3M3TeLWlAgRj7uUnryXWZjXU5AWjwEkin5oQHL15en2Ct5LkMHbeHZvxajlHbLKBjBNF3akGNaZQnTUx7oEPUnpefnOGWb8xpYZLJUDcpqeitpPTpgH0pL7qvAgfxwF9XgaHwX2tcNy6IoXHpEV3NSC62wwJklVksR4";
    const useCdn = true;
    axios
      .get(
